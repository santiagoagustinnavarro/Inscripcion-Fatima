...
<body style="background:#b3ccff;">
    ...
    <center>
        <div style="position:relative; left:0px;top:150px;width:650px;">
            ...
            <?php $form=ActiveForm::begin(['method' => 'post','class'=>'input','action' => ['usuario/iniciado'],]);?>
            <input type="number" name="legajo" class=" input_personalizado active_input"
                placeholder="legajo.." /><br><br>
            <input type="password" name="clave" class=" input_personalizado active_input"
                placeholder=" clave..." /><br><br>
